...
这是一个纯静态的照片纪念册，可以直接部署到 GitHub Pages。

当前版本支持：

- 默认展示 `photos/` 里的 14 张照片
- 分类浏览照片：一起出门、看展、日常、纪念、心意
- 搜索标题、地点、留言和标签
- 点击卡片打开大图预览
...
新增照片需要修改仓库文件，再重新发布到 GitHub Pages。具体步骤见 [ADD_MEDIA_GUIDE.md](./ADD_MEDIA_GUIDE.md)。
